...
contract Whitelist {
    ...
    // if an address is whitelisted, we would set it to true, it is false by default for all otherr addresses.
    mapping(address => bool) public whitelistedAddresses;

    // numAddressesWhitelisted would be used to keep track of how many addresses have been whitelisted
    // NOTE: Don't change this variable name, as it will be part of verfication
    ...
    */
    function addAddressToWhitelist() public {
        ...
        // check if the numAddressesWhitelisted < maxWhitelistedAddresses, if mot then error.
